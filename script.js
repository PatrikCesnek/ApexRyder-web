const translations = {
  en: {
    ...
    "difficulty.eyebrow": "Pick your road",
    "difficulty.title": "Three roads. One set of physics.",
    "difficulty.text": "Before your first ride you choose a road — how busy it is, nothing else. The simulation underneath is identical on every tier.",
    "difficulty.easy.title": "Easy",
    "difficulty.easy.text": "For beginner riders. A quiet stretch of road — just a few cars in either direction and the odd hazard. Learn the bike.",
    "difficulty.easy.traffic": "Light traffic",
    "difficulty.medium.title": "Medium",
    "difficulty.medium.text": "For experienced riders looking for a proper challenge. Busier traffic in both directions and more hazards on the tarmac.",
    "difficulty.medium.traffic": "Busy traffic",
    "difficulty.hard.title": "Hard",
    "difficulty.hard.text": "Genuine road-demon territory. The road is crawling with cars and hazards — this is where you prove your skills. Good luck.",
    "difficulty.hard.traffic": "Rush-hour traffic",
    "difficulty.footer": "Same bike. Same physics. You're only choosing the road.",
    "gallery.eyebrow": "In the cockpit",
    "gallery.title": "See it in action.",
    "gallery.menu.caption": "Main menu — shift into first and go.",
    "gallery.riding.caption": "Crash, then the numbers: distance ridden and your personal best.",
  ...
  sk: {
    ...
    "difficulty.eyebrow": "Vyber si cestu",
    "difficulty.title": "Tri cesty. Jedna fyzika.",
    "difficulty.text": "Pred prvou jazdou si vyberieš cestu — len to, aká je rušná, nič viac. Simulácia pod ňou je na každej úrovni identická.",
    "difficulty.easy.title": "Ľahká",
    "difficulty.easy.text": "Pre začínajúcich jazdcov. Pokojný úsek cesty — len zopár áut v oboch smeroch a sem-tam prekážka. Spoznaj svoju motorku.",
    "difficulty.easy.traffic": "Slabá premávka",
    "difficulty.medium.title": "Stredná",
    "difficulty.medium.text": "Pre skúsených jazdcov, ktorí hľadajú poriadnu výzvu. Hustejšia premávka v oboch smeroch a viac prekážok na asfalte.",
    "difficulty.medium.traffic": "Hustá premávka",
    "difficulty.hard.title": "Ťažká",
    "difficulty.hard.text": "Skutočná liga cestných démonov. Cesta sa hemží autami a prekážkami — tu ukážeš, čo vieš. Veľa šťastia.",
    "difficulty.hard.traffic": "Premávka ako v špičke",
    "difficulty.footer": "Rovnaká motorka. Rovnaká fyzika. Vyberáš si len cestu.",
    "gallery.eyebrow": "V kokpite",
    "gallery.title": "Pozri si to v akcii.",
    "gallery.menu.caption": "Hlavné menu — zaraď jednotku a choď.",
    "gallery.riding.caption": "Pád, potom čísla: prejdená vzdialenosť a tvoj osobný rekord.",
  ...
  cs: {
    ...
    "difficulty.eyebrow": "Vyber si silnici",
    "difficulty.title": "Tři silnice. Jedna fyzika.",
    "difficulty.text": "Před první jízdou si vybereš silnici — jen to, jak je rušná, nic víc. Simulace pod ní je na každé úrovni identická.",
    "difficulty.easy.title": "Lehká",
    "difficulty.easy.text": "Pro začínající jezdce. Klidný úsek silnice — jen pár aut v obou směrech a občasná překážka. Poznej svou motorku.",
    "difficulty.easy.traffic": "Slabý provoz",
    "difficulty.medium.title": "Střední",
    "difficulty.medium.text": "Pro zkušené jezdce, kteří hledají pořádnou výzvu. Hustší provoz v obou směrech a více překážek na asfaltu.",
    "difficulty.medium.traffic": "Hustý provoz",
    "difficulty.hard.title": "Těžká",
    "difficulty.hard.text": "Opravdová liga silničních démonů. Silnice se hemží auty a překážkami — tady ukážeš, co umíš. Hodně štěstí.",
    "difficulty.hard.traffic": "Provoz jako ve špičce",
    "difficulty.footer": "Stejná motorka. Stejná fyzika. Vybíráš si jen silnici.",
    "gallery.eyebrow": "V kokpitu",
    "gallery.title": "Podívej se na to v akci.",
    "gallery.menu.caption": "Hlavní menu — zařaď jedničku a jeď.",
    "gallery.riding.caption": "Pád, pak čísla: ujetá vzdálenost a tvůj osobní rekord.",
